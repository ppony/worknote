 ...
 * @version  V3.00
 * $Revision: 2 $
 * $Date: 16/07/20 11:30a $
 * @brief    M0564 series UART Interface Controller (UART) driver header file
 *
 * @note
...
#define UART5_FIFO_SIZE 16 /*!< UART2 supports separated receive/transmit 16/16 bytes entry FIFO */    
#define UART6_FIFO_SIZE 16 /*!< UART2 supports separated receive/transmit 16/16 bytes entry FIFO */    
