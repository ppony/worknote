 ...
 * @version  V3.0
 * $Revision: 14 $
 * $Date: 16/08/15 10:47a $
 * @brief    M0564 series Clock Controller (CLK) driver header file
 *
 * @note
...
#define CLK_CLKSEL0_HCLKSEL_PLL_DIV2    (0x04UL<<CLK_CLKSEL0_HCLKSEL_Pos) /*!< Setting HCLK clock source as PLL/2 */
...
#define CLK_CLKSEL0_SDH1SEL_HXT         (0x00UL<<CLK_CLKSEL0_SDH1SEL_Pos) /*!< Setting SDH1 clock source as HXT */
#define CLK_CLKSEL0_SDH1SEL_PLL         (0x01UL<<CLK_CLKSEL0_SDH1SEL_Pos) /*!< Setting SDH1 clock source as PLL */
#define CLK_CLKSEL0_SDH1SEL_HCLK        (0x02UL<<CLK_CLKSEL0_SDH1SEL_Pos) /*!< Setting SDH1 clock source as HCLK */
#define CLK_CLKSEL0_SDH1SEL_HIRC        (0x03UL<<CLK_CLKSEL0_SDH1SEL_Pos) /*!< Setting SDH1 clock source as HIRC */
...
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKSEL1_WDTSEL_HXT           (0x0UL<<CLK_CLKSEL1_WDTSEL_Pos)  /*!< Setting WDT clock source as HXT */
...
#define CLK_CLKSEL1_DSRCSEL_HIRC48       (0x0UL<<CLK_CLKSEL1_DSRCSEL_Pos)  /*!< Setting DSRC clock source as HIRC48 */
...
#define CLK_CLKSEL1_WWDTSEL_HXT          (0x0UL<<CLK_CLKSEL1_WWDTSEL_Pos) /*!< Setting WWDT clock source as HXT */
#define CLK_CLKSEL1_WWDTSEL_LXT          (0x1UL<<CLK_CLKSEL1_WWDTSEL_Pos) /*!< Setting WWDT clock source as LXT */
...
#define CLK_CLKDIV1_DSRC(x)     (((x)-1) << CLK_CLKDIV1_DSRC_Pos)    /*!< CLKDIV1 Setting for DSRC clock divider. It could be 1~64 */


/*---------------------------------------------------------------------------------------------------------*/
/*  CLKDIV2 constant definitions.                                                                           */
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKDIV2_SDH1(x)     (((x)-1) << CLK_CLKDIV2_SDH1DIV_Pos)  /*!< CLKDIV2 Setting for SDH1 clock divider. It could be 1~256 */


/*---------------------------------------------------------------------------------------------------------*/
/*  CLKDIV3 constant definitions.                                                                           */
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKDIV3_UART2(x)     (((x)-1) << CLK_CLKDIV3_UART2DIV_Pos)  /*!< CLKDIV3 Setting for UART2 clock divider. It could be 1~16 */
#define CLK_CLKDIV3_UART3(x)     (((x)-1) << CLK_CLKDIV3_UART3DIV_Pos)  /*!< CLKDIV3 Setting for UART3 clock divider. It could be 1~16 */
#define CLK_CLKDIV3_UART4(x)     (((x)-1) << CLK_CLKDIV3_UART4DIV_Pos)  /*!< CLKDIV3 Setting for UART4 clock divider. It could be 1~16 */
#define CLK_CLKDIV3_UART5(x)     (((x)-1) << CLK_CLKDIV3_UART5DIV_Pos)  /*!< CLKDIV3 Setting for UART5 clock divider. It could be 1~16 */


/*---------------------------------------------------------------------------------------------------------*/
/*  PLLCTL constant definitions. PLL = FIN * (2*NF) / NR / NO                                              */
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_PLLCTL_PLLSRC_HXT   0x00000000UL    /*!< For PLL clock source is HXT.  4MHz < FIN < 8MHz */
#define CLK_PLLCTL_PLLSRC_HIRC  0x00080000UL    /*!< For PLL clock source is HIRC. 4MHz < FIN < 8MHz */

#define CLK_PLLCTL_NF(x)        ((x)-2)         /*!< x must be constant and 2 <= x <= 513. 200MHz < FIN*(2*NF)/NR < 500MHz */
#define CLK_PLLCTL_NR(x)        (((x)-1)<<9)    /*!< x must be constant and 2 <= x <= 33.  4MHz < FIN/NR < 8MHz */
...
#define CLK_PLLCTL_96MHz_HXT    (CLK_PLLCTL_PLLSRC_HXT  | CLK_PLLCTL_NR(2) | CLK_PLLCTL_NF(32) | CLK_PLLCTL_NO_4) /*!< Predefined PLLCTL setting for 96MHz PLL output with HXT */
#define CLK_PLLCTL_96MHz_HIRC   (CLK_PLLCTL_PLLSRC_HIRC | CLK_PLLCTL_NR(2) | CLK_PLLCTL_NF(32) | CLK_PLLCTL_NO_4) /*!< Predefined PLLCTL setting for 96MHz PLL output with HIRC0 */
...
#define MODULE_CLKDIV(x)        (((x) >>18) & 0x3)    /*!< Calculate APBCLK CLKDIV on MODULE index, 0x0:CLKDIV0, 0x1:CLKDIV1, 0x2:CLKDIV3, 0x4:CLKDIV4 */
...
#define SDH1_MODULE    (MODULE_APBCLK_ENC( 0)|MODULE_IP_EN_Pos_ENC(CLK_AHBCLK_SDH1CKEN_Pos)|\
                        MODULE_CLKSEL_ENC( 0)|MODULE_CLKSEL_Msk_ENC( 3)|MODULE_CLKSEL_Pos_ENC(22)|\
                        MODULE_CLKDIV_ENC( 2)|MODULE_CLKDIV_Msk_ENC(0xFF)|MODULE_CLKDIV_Pos_ENC(24))    /*!< SDH1 Module */
...
#define DSRC_MODULE    (MODULE_APBCLK_ENC( 1)|MODULE_IP_EN_Pos_ENC(CLK_APBCLK0_DSRCCKEN_Pos)|\
                        MODULE_CLKSEL_ENC(NA)|MODULE_CLKSEL_Msk_ENC(NA)|MODULE_CLKSEL_Pos_ENC(NA)|\
                        MODULE_CLKDIV_ENC( 0)|MODULE_CLKDIV_Msk_ENC(0x0F)|MODULE_CLKDIV_Pos_ENC( 8))    /*!< DSRC Module */
...
#define I2S0_MODULE    (MODULE_APBCLK_ENC( 1)|MODULE_IP_EN_Pos_ENC(CLK_APBCLK0_I2SCKEN_Pos)|\
                        MODULE_CLKSEL_ENC( 3)|MODULE_CLKSEL_Msk_ENC( 3)|MODULE_CLKSEL_Pos_ENC(16)|\
                        MODULE_CLKDIV_ENC( 0)|MODULE_CLKDIV_Msk_ENC(0xFF)|MODULE_CLKDIV_Pos_ENC(16))    /*!< I2S0 Module */
...
#define SC2_MODULE     (MODULE_APBCLK_ENC( 2UL)|MODULE_IP_EN_Pos_ENC(CLK_APBCLK1_SC2CKEN_Pos)  |\
                        MODULE_CLKSEL_ENC( 3)|MODULE_CLKSEL_Msk_ENC( 0)|MODULE_CLKSEL_Pos_ENC( 4)|\
...
#define SPI5_MODULE    (MODULE_APBCLK_ENC( 1)|MODULE_IP_EN_Pos_ENC(CLK_APBCLK1_SPI5CKEN_Pos)|\
                        MODULE_CLKSEL_ENC( 2)|MODULE_CLKSEL_Msk_ENC( 3)|MODULE_CLKSEL_Pos_ENC(14)|\
                        MODULE_CLKDIV_ENC(NA)|MODULE_CLKDIV_Msk_ENC(NA)|MODULE_CLKDIV_Pos_ENC(NA))    /*!< DSRC Module */
...
#define LCD_MODULE     (MODULE_APBCLK_ENC( 2UL)|MODULE_IP_EN_Pos_ENC(CLK_APBCLK1_LCDCKEN_Pos)|\
                        MODULE_CLKSEL_ENC(NA)|MODULE_CLKSEL_Msk_ENC(NA)|MODULE_CLKSEL_Pos_ENC(NA)|\
...
#define OPA_MODULE     (MODULE_APBCLK_ENC( 2UL)|MODULE_IP_EN_Pos_ENC(CLK_APBCLK1_OPACKEN_Pos)|\
                        MODULE_CLKSEL_ENC(NA)|MODULE_CLKSEL_Msk_ENC(NA)|MODULE_CLKSEL_Pos_ENC(NA)|\
