 ...
 *
 ******************************************************************************/
#ifndef __SYSTEM_TC8234_H__
#define __SYSTEM_TC8234_H__
...
#define __HSI       (66000000UL)    /*!< PLL default output is 66MHz@HIRC0 */
